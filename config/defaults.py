...
_C.DATASETS.FILTER_MORE_STRICTLY = False
_C.DATASETS.FILTER_MORE_SMOOTHLY = False
...
# 以上为原版
_C.MODEL.HEAD.LOSS_ALPHA = 0.5
_C.MODEL.HEAD.LOSS_GAMMA = 2.5
...
_C.MODEL.HEAD.LOSS_PENALTY_ALPHA = 1.5
_C.MODEL.HEAD.LOSS_BETA = 3
...
_C.MODEL.HEAD.PRED_DIRECT_DEPTH = True
_C.MODEL.HEAD.PRED_GROUND_PLANE = False
_C.MODEL.HEAD.HORIZON_GAUSSIAN_RADIUS = 1
_C.MODEL.HEAD.WEIGHTINCREASED = False
_C.MODEL.HEAD.USE_EDGE_SLOPE = False
_C.MODEL.HEAD.HORIZON_FITTING_METHOD = 'LS'
_C.MODEL.HEAD.PRED_MULTI_Y3D = False
...
_C.TEST.VIS = False
_C.TEST.VIS_ALL = False
_C.TEST.VIS_DEPTH_ERROR = False
_C.TEST.VIS_HEIGHT_ERROR = False
_C.TEST.VIS_POINT_ERROR = False
_C.TEST.COMPENSATORY_TEST = False
_C.TEST.STA_EDGE_CASE = False
_C.TEST.FLIP_TYPE = 'none'
...
_C.COMPUTE_SOFT_DEPTH_LOSS = True

# linear or log or exp; use std or not
_C.Y3D_REG = ['exp', True]
_C.FIXED_Y3D = False
_C.USE_Y3D_ALONE = False
