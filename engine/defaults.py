...
def default_argument_parser():
    ...
    parser.add_argument("--vis_all", action="store_true", help="visualize all depths result when evaluating")
    parser.add_argument("--vis_horizon", action="store_true", help="visualize horizon when evaluating")
    ...
    parser.add_argument("--num_work", type=int, default=0, help="number of workers for dataloader")
    parser.add_argument("--output", type=str, default=None)

    parser.add_argument("--vis_thre", type=float, default=0.2, help="threshold for visualize results of detection")
